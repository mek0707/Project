...
function index() {
  ...
  return (
    <div>
      <div className="text-center text-[20px] font-bold p-2 underline">
      ...
      <div className={`grid grid-cols-2 lg:grid-cols-3 gap-4 text-center p-4`}>
        <div className="col-span-2 lg:col-span-1 border">
          <div className="mb-4 p-4 bg-gray-200 font-bold">
        ...
        <div className="col-span-1 border">
          <div className="mb-4 p-4 bg-gray-200 font-bold">Fruit</div>
          <div
            className={`flex flex-col gap-4 h-[30vh] lg:h-[60vh] overflow-auto mb-4`}
          >
        ...
        <div className="col-span-1 border">
          <div className="mb-4 p-4 bg-gray-200 font-bold">Vegetable</div>
          <div
            className={`flex flex-col gap-4 h-[30vh] lg:h-[60vh] overflow-auto mb-4`}
          >
            {dataTemporary.map((item, index) => {
